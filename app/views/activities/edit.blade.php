...
@section('content')
	...
	<div class="form-group col-12">
		<div class="col-offset-1 col-12">
			...
			<button class="btn btn-primary sameSizeButton" data-toggle="modal" data-target="#processesModal" data-controls-modal="your_div_id" data-backdrop="static" data-keyboard="false">{{ trans('ui.processes') }}</button>
