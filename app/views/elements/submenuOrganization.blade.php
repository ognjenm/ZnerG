<nav class="navbar navbar-default secondaryMenu" role="navigation">	
	...
	<ul class="nav navbar-nav col-9">					
		{{ Form::open(array('url' => array($modelName . '/search'),
			...
			<li>
				<div class="searchBox input-group input-group-xs col-6">
		...
		@if (Auth::user()->id == 1)	
			<li>
			    <div class="dropdown col-3">
					{{ Form::select('id_organization', $organizations, $id_organization, array('class' => 'dropdown selectpicker', 'onchange' => 'ddField();')) }}
			    </div>
			</li>
		@endif
		{{ Form::close() }}
